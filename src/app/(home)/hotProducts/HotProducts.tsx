...
import { MdKeyboardArrowRight, MdKeyboardDoubleArrowRight, MdOutlineKeyboardArrowLeft, MdOutlineKeyboardArrowRight } from 'react-icons/md'
  ...
  return (
    ...
    <Container>
      ...
      <div className='relative flex gap-5 mt-5'>
        <div 
         className={`absolute md:static top-0 z-10 transition-all duration-300
          ease-in-out flex-1 px-5 py-7 bg-white shadow 
          ...
          <input type="range" min={10}  max={20000} value={price}
          onChange={(e) => setPrice(parseFloat(e.target.value))} className='w-4/5 '/>

...
const Hero = () => {
  return (
    <section className='pt-32'>
        ...
        <div className='relative w-52 h-52 rounded-full hidden md:flex justify-center items-center bg-white
         before:content-[""] before:absolute before:top-[8px] before:right-[8px] before:bottom-[8px]
         before:left-[8px] before:rounded-full before:border-4 before:border-dashed before:border-black ' >
        ...
        <div className=' hidden md:flex items-center gap-8'>
          <div className='hidden lg:block text-3xl'>
            <p>A NEW <span className='text-pink-500'> GREAT LOOK </span>
             </p>
